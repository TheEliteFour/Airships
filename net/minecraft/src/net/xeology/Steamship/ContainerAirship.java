...
public class ContainerAirship extends Container {
    ...
    {
        addSlotToContainer(new SlotAirship(inventoryplayer.player,entityairship, 13, 134, 16));
        addSlotToContainer(new SlotAirship(inventoryplayer.player,entityairship, 12, 134, 52));
	
        for (int i = 0; i < 3; i++)
        {
            for (int l = 0; l < 4; l++)
            {
                addSlotToContainer(new SlotAirship(inventoryplayer.player,entityairship, l + i * 4, 8 + l * 18, 16 + i * 18));
            }
        }
